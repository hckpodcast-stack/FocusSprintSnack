...
import { View, Text, Pressable, StyleSheet, StatusBar, SafeAreaView, ScrollView, Alert } from 'react-native';
...
export default function LandingPage() {
  ...
  const handleGetStarted = () => {
    Alert.alert(
      'Check-in preview coming soon',
      'We are still polishing the guided check-in experience. Stay tuned!'
    );
  };
